...
const PaymentDetails = props => (
    <React.Fragment>
        ...
        <div className="text-left my-8 mx-4">
            ...
            <ul className="mb-8">
                <li><span className="font-bold">Meals and Snacks</span> - Php 00.00</li>
                <li><span className="font-bold">Logistics</span> - Php 00.00</li>
                <li><span className="font-bold">Games Awards</span> - Php 00.00</li>
            </ul>
            <Divider />
            <h3 className="mb-4">How to Pay</h3>
            <Steps direction="vertical" current={props.current}>
                <Step title="Deposit Payment" icon={<Icon type="bank" />} description={<span>Deposit your payment through <span className="font-bold">BPI</span> under a joint account (<span className="font-bold">MA BETH SOLAS CONCEPCION</span> and <span className="font-bold">SHEM DURST ELIJAH BALIGUAT SANDIG</span>) with an account number: <span className="font-bold">1339 368288</span></span>} />
